...
const products: IProduct[] = [
  {
    ...
    text: 'Основы, типы, компилятор, классы, generic, утилы, декораторы, advanced...',
  ...
  },
  {
    ...
    text: 'BLD, история версий, ветвление, удаленный репозиторий, релизы, opensiurse...',
    time: 'С опытом • 2 недели',
    type: ProductType.Skill,
  },
  {
    ...
    text: 'Redux, React Redux, Redux DevToils, Redux DevTools, Redux Toolkit,RTK Query, MobX...',
    time: 'С опытом • 2 недели',
    type: ProductType.Skill,
  },
  {
  ...
  {
    id: '920',
    title: 'Первая ступень професси frontend-разработчика',
  ...
  {
    id: '930',
    title: 'Вторая ступень професси frontend-разработчика',
  ...
  },
  {
    ...
    text: 'основы работы с модальным окном, логикка прогресса-бара, checkboc, формы, валидация',
    time: 'С оптытом • 1 неделя',
    type: ProductType.Intensive,
  },
  {
    id: '33',
    ...
    text: 'Wedpack, Jext, Node.js, State Managers, ООП, ESlint, SASS, Data LAyer',
    time: 'С опытом • 2 месяц',
    type: ProductType.Intensive,
  },
  {
    id: '28',
  ...
  },
  {
    ...
    text: 'отличия Junior от Middle, необходимый стек, soft skills, как расти в зарплате',
    time: 'С нуля • 2 дня',
    type: ProductType.Course,
  },
  {
    ...
    text: '4 шага к карьере в IT, греды и зарплата frontend-разработчика, технологии для старата...',
    time: 'С нуля • 2 дня',
    type: ProductType.Course,
  },
];
